...
var createPool = exports.createPool = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(options) {
        var create = function () {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        options.retry_strategy = options.retry_strategy || function (options) {
                            // 1s 重连
                            return 100;
                        };
...
var createPoolWith = exports.createPoolWith = function () {
    var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(options) {
...
var debug = require('debug')('mofier:kv2:connect:pool');
var debugerror = require('debug')('mofier:kv2:connect:pool:error');
